...
if __package__ in {None, ""}:
    ...
    from .production_model_registry import DEFAULT_CHAMPION_REFERENCE_PATH, resolve_champion_reference
...
def main() -> None:
    ...
    parser.add_argument("--config-path", default=str(PROJECT_ROOT / "configs" / "response_scoring.yaml"))
    parser.add_argument("--scoring-pt", default=None)
    ...
    run_summary = {
        "as_of_date": scoring_config["as_of_date"],
        "scoring_pt": scoring_pt,
