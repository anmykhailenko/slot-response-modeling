...
create table if not exists pai_rec_prod.ads_uplift_phase1_response_monitoring_daily_di (
    ...
    positive_prediction_count bigint comment 'rows with predicted_response_score greater than or equal to selected_threshold',
    negative_prediction_count bigint comment 'rows with predicted_response_score below selected_threshold',
    predicted_positive_rate double comment 'share of rows with predicted_response_score greater than or equal to selected_threshold',
    predicted_negative_rate double comment 'share of rows with predicted_response_score below selected_threshold',
